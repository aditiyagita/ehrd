...
header("Content-Disposition: attachment; filename=penggajian-".$data['bulan']."/".$data['tahun'].".xls");
?>

<center>
	<table width=100%>
		<tr>
			<td colspan=3><img src="{{ 'http://localhost/wangwha/public/assets/img/hvh.jpg' }}"/></td>
	...
	<table width=100% class="laporan">
		...
		<tr>
			...
			<td>{{ number_format($penggajian->karyawan->norekening, 0, ',', '.') }}</td>
