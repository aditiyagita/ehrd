                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                                ...
                                {{ Form::model($data["jobvacancy"], array('method' => 'PATCH','files'=> 'true', 'onsubmit' => 'return checkSize(2097152)', 'route' => array('hrdstaff.job-vacancy.update', $data["jobvacancy"]->idlowongan))) }}
                                ...
                                <div class="box-content nopadding" style="padding-top:15px">
                                    <br>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="tanggalakhir" value="{{ date('m/d/Y', strtotime($data['jobvacancy']->tanggalakhir)) }}" id="tanggalakhir" class="input-block-level datepick" required> 
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="department" id="department" class='input-block-level' required>
                                                    ...
                                                    @foreach ($data['department'] as $department)
                                                        @if($data['jobvacancy']->iddepartment == $department->iddepartment)
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="posisi" value="{{ $data['jobvacancy']->posisi }}" id="posisi" placeholder="Posisi" class="input-block-level" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="department" class="control-label">Judul</label>
                                            <div class="controls">
                                                <input type="text" name="judul" value="{{ $data['jobvacancy']->judul }}" id="judul" placeholder="Judul" class="input-block-level" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="{{Url::asset('assets/images/jobvacancy/'.$data['jobvacancy']->foto)}}"></div>
