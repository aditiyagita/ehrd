			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12" style="padding-top:20px">
						<a href="#modal-1" role="button" class="btn btn-brown btn-large" data-toggle="modal"><i class="icon-plus"></i>Tambah Ruang Kelas</a>
									...
									<tbody>
										...
										@foreach($data['agama'] as $agama)
											<tr>
												...
												<td class='hidden-480'>
													<center>
														<a href="{{ Url::asset('hrdstaff/agama/'.$agama->idagama.'/edit') }}" class="btn btn-green edit" rel="tooltip" title="Edit"><i class="icon-edit"></i></a>
														<a href="javascript:hapusAction({{ $agama->idagama }})" class="btn btn-red" rel="tooltip" title="Delete"><i class="icon-remove"></i></a>
													</center>
												</td>
											</tr>
											<?php $i++; ?>
...
<div id="modal-1" class="modal hide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    {{ Form::open(array('route' => 'hrdstaff.agama.store', 'class' => 'form-horizontal')) }}
    <div class="modal-body">
