                        ...
                        <div class="box">
                                ...
                                <div class="box-content nopadding" style="padding-top:15px">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" value="{{ $data['pelatihan']->biaya }}" name="biaya" id="biaya" class="input-block-level" required>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="dp" class="control-label">DP</label>
                                        <div class="controls">
                                            <input type="text" value="{{ $data['pelatihan']->dp }}" name="dp" id="dp" class="input-block-level" required>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="pelunasan" class="control-label">Pelunasan</label>
                                        <div class="controls">
                                            <input type="text" value="{{ $data['pelatihan']->pelunasan }}" name="pelunasan" id="pelunasan" class="input-block-level" required>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="kuota" class="control-label">Kuota</label>
                                        <div class="controls">
                                            <input type="text" value="{{ $data['pelatihan']->kuota }}" name="kuota" id="kuota" class="input-block-level" required>
                                        </div>
                                    </div>
                                    <div class="control-group">
