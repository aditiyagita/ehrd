                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                                ...
                                {{ Form::model($data["jobvacancy"], array('method' => 'PATCH', 'route' => array('hrdstaff.job-vacancy.update', $data["jobvacancy"]->idjobvacancy))) }}
                                <div class="box-content nopadding" style="padding-top:15px">
                                    <br>
                                    <div class="control-group">
                                            <label for="tanggalakhir" class="control-label">Tanggal Akhir</label>
                                            <div class="controls">
                                                <input type="text" name="tanggalakhir" value="{{ date('m/d/Y', strtotime($data['jobvacancy']->tanggalakhir)) }}" id="tanggalakhir" class="input-block-level datepick">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="judul" value="{{ $data['jobvacancy']->judul }}" id="judul" placeholder="Judul" class="input-block-level">
                                            </div>
                                        </div>
                                </div>
